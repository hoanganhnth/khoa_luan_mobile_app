...
class DropdownAlertWidget extends State<DropdownAlert>
  ...
  String? title;
  String? message;
  TypeToastWidget toastWidget = TypeToastWidget.normal;
  ToastType? type;
  ...
  show(String title, String message, ToastType type,
      TypeToastWidget typeToastWidget,
      [Map<String, dynamic>? payload]) {
    final delay = getDelay(
        customDelay: typeToastWidget == TypeToastWidget.custom ? 3000 : null);
    ...
    return AnimatedBuilder(
      ...
      builder: (c, v) => Positioned(
        ...
        child: GestureDetector(
          ...
          child: toastWidget == TypeToastWidget.custom
              ? imageFromLocale(
                  url: 'assets/images/login/bg_toast.png',
